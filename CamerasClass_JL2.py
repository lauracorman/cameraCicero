...
#    def openCamera(self):
#        print 'Opening Contact Chameleon'
#        return True
...
#        self._setup_camera()
        self._name = 'Chameleon camera ' + str(number)
    
    def closeCamera(self):
        print "shutting down Contact Chameleon, en fait marche pas"    
#        context.Stop()
#        context.Destroy()
        return 0
...
#        
    ...
    def _getCameraInfo(self):
#        print pyfly1.get_camera_information()
        return pyfly1.get_camera_information()
